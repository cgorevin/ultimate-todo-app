...
class ActiveRecord::Base
  ...
  def self.establish_connection_without_activerecord_import(config_or_env = nil); end
...
module ActiveRecord::Import::SQLite3Adapter
  ...
  def increment_locking_column!(results, locking_column); end
  def insert_many(sql, values, _options = nil, *args); end
  def next_value_for_sequence(sequence_name); end
  def post_sql_statements(table_name, options); end
  def pre_sql_statements(options); end
  ...
  def sql_for_on_duplicate_key_update(_table_name, *args); end
  def sql_for_on_duplicate_key_update_as_array(locking_column, arr); end
  def sql_for_on_duplicate_key_update_as_hash(locking_column, hsh); end
  def supports_import?(current_version = nil); end
  def supports_on_duplicate_key_update?(current_version = nil); end
